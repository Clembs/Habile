  ...
  smp: {
    guide: {
      ...
      steps: [
        ...
        [
          'Connectez-vous !',
          "Afin d'éviter les abus de comptes crackés, vous devrez créer un mot de passe à utiliser pour chaque future connexion.",
        ],
        [
          'Rejoignez une équipe ou créez-en une !',
          "C'est facultatif, mais vous pouvez rejoindre ou créer une équipe !",
        ],
      ],
    },
  },
